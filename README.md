...
The 'quality_control_manufacturing_medallion_pipeline' project was generated by using the lakeflow-pipelines template.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] quality_control_manufacturing_medallion_pipeline_etl` to your workspace.
